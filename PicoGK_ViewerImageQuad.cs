...
namespace PicoGK
{
    ...
    {
        public partial class ImageQuad
        {
            public ImageQuad(   Viewer oSetViewer,
                                ImageRgba32 img,
                                ColorFloat clrDefault,
                                float fAlpha,
                                Matrix4x4 matDefault,
                                bool bFlipX,
                                bool bFlipY,
                                bool bDoubleSided)
            {
                oViewer = oSetViewer;
                m_oTex = new(oSetViewer, img);
            ...
            {
                m_oTex.ReplaceWith(img);
                oViewer.RequestUpdate();
            }
